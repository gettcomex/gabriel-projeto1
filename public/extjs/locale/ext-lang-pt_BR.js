...
Ext.onReady(function() {
    ...
    Ext.define("Ext.locale.pt_BR.form.field.Text", {
        ...
        minLengthText: "&Eacute; muito curto (m&iacute;nimo: {0} caracteres).",
        maxLengthText: "&Eacute; muito longo (m&aacute;ximo: {0} caracteres).",
        blankText: "N&atilde;o pode ficar em branco.",
        regexText: "",
        emptyText: null
    });
    ...
    if (exists('Ext.form.field.VTypes')) {
        Ext.apply(Ext.form.field.VTypes, {
            emailText: 'deve ser um endere&ccedil;o de e-mail v&aacute;lido, no formato "usuario@dominio.com.br".',
            urlText: 'deve ser uma URL no formato "http:/' + '/www.dominio.com.br".',
            alphaText: 'deve conter apenas letras e _',
            alphanumText: 'deve conter apenas letras, n&uacute;meros e _'
        });
    }
